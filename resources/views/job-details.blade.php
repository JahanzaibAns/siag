@extends('layout.main')
@section('title')
{{ $job->title }} | Careers | SIAG
@endsection
@section('meta_description')
Apply for {{ $job->title }} at SIAG. View full job details, requirements, and apply online. Careers at Sindh Institute of Advanced Endoscopy and Gastroenterology.
@endsection
@section('content')
  <!-- Start Page Heading -->
